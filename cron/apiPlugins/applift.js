...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Applift' }, {});
        if (result) {
        ...
        console.log("Applift Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Applift");
