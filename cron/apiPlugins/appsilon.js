...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Appsilon' }, {});
        if (result) {
        ...
        console.log("Appsilon Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Appsilon");
