...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Curate' }, {});
        if (result) {
        ...
        console.log("Curate Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Curate");
