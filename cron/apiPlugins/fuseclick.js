...
exports.callFuseclickApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Fuseclick' }, {});
        if (result) {
        ...
        console.log("Fuseclick Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Fuseclick");
