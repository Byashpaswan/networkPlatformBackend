...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Hopemobi' }, {});
        if (result) {
        ...
        console.log("Hopemobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Hopemobi");
