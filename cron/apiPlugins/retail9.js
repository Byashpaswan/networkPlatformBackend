...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Retail9' }, {});
        if (result) {
        ...
        console.log("Retail9 Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Retail9");
