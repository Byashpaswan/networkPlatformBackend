...
exports.callLinkgoAdsApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Linkgoads' }, {});
        if (result) {
        ...
        console.log("Linkgoads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Linkgoads");
