...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Vinetool' }, {});
        if (result) {
        ...
        console.log("Vinetool Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Vinetool");
