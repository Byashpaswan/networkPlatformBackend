...
exports.callMybestclickApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mybestclick' }, {});
        if (result) {
        ...
        console.log("Mybestclick Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mybestclick");
