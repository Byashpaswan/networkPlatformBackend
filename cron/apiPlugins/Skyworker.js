...
exports.callSkyworkerApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Skyworker' }, {});
        if (result) {
        ...
        console.log("Skyworker Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Skyworker");
