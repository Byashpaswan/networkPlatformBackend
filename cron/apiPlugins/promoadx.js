...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Promoadx/Mobvortex' }, {});
        if (result) {
        ...
        console.log("Promoadx Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Promoadx");
