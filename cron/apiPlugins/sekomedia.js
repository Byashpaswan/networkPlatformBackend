...
exports.callsekomediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Sekomedia' }, {});
        if (result) {
        ...
        console.log("Sekomedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Sekomedia");
