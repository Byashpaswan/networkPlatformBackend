...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Pentamob/LeanMobi' }, {});
        if (result) {
        ...
        console.log("Pentamob Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Pentamob");
