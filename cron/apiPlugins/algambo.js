...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Algambo' }, {});
        if (result) {
        ...
        console.log("Algambo Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Algambo");
