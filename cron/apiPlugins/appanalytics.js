...
exports.callAddattainApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Appanalytics' }, {});
        if (result) {
        ...
        console.log("Addattain Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Addattain");
