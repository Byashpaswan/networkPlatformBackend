...
exports.callGourdmobiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Gourdmobi' }, {});
        if (result) {
        ...
        console.log("Gourdmobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Gourdmobi");
