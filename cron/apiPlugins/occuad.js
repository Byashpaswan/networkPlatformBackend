...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Occuad' }, {});
        if (result) {
        ...
        console.log("Occuad Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Occuad");
