...
exports.callAddotlineApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Addotline' }, {});
        if (result) {
        ...
        console.log("Addotline Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Addotline");
