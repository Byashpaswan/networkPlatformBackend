...
exports.callTrackrevenueApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Trackrevenue' }, {});
        if (result) {
        ...
        console.log("Trackrevenue Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Trackrevenue");
