...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Seanear' }, {});
        if (result) {
        ...
        console.log("Seanear Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Seanear");
