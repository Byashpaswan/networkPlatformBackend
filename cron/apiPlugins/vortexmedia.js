...
exports.callVortexmediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Vortexmedia' }, {});
        if (result) {
        ...
        console.log("Vortexmedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Vortexmedia");
