...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Pivomob' }, {});
        if (result) {
        ...
        console.log("Pivomob Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Pivomob");
