...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Adsplay' }, {});
        if (result) {
        ...
        console.log("Adsplay Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Adsplay");
