...
exports.callCollectCentApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'CollectCent' }, {});
        if (result) {
        ...
        console.log("CollectCent Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs CollectCent");
