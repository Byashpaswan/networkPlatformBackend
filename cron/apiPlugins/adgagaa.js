...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Adgagaa' }, {});
        if (result) {
        ...
        console.log("Adgagaa Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Adgagaa");
