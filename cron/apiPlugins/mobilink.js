...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobilink' }, {});
        if (result) {
        ...
        console.log("Mobilink Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobilink");
