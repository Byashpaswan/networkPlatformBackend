...
const debug = require("debug")("darwin:Plugin:Admedx");
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Admedx' }, {});
        if (result) {
        ...
        console.log("Admedx Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Admedx");
