...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Chestnut' }, {});
        if (result) {
        ...
        console.log("Chestnut Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Chestnut");
