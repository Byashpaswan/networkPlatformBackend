...
exports.callInformadzApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Informadz' }, {});
        if (result) {
        ...
        console.log("Informadz Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Informadz");
