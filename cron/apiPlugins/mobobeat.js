...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobobeat' }, {});
        if (result) {
        ...
        console.log("Mobobeat Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobobeat");
