...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Cityads' }, {});
        if (result) {
        ...
        console.log("Cityads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Cityads");
