...
exports.callResultMediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'ResultMedia' }, {});
        if (result) {
        ...
        console.log("ResultMedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs ResultMedia");
