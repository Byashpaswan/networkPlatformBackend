...
exports.callRoidynamicApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Roidynamic' }, {});
        if (result) {
        ...
        console.log("Roidynamic Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Roidynamic");
