...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Batmobi' }, {});
        if (result) {
        ...
        console.log("Batmobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Batmobi");
