...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Imocash' }, {});
        if (result) {
        ...
        console.log("Imocash Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Imocash");
