...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobrand' }, {});
        if (result) {
        ...
        console.log("Mobrand Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobrand");
