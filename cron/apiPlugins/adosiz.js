...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Adosiz' }, {});
        if (result) {
        ...
        console.log("Adosiz Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Adosiz");
