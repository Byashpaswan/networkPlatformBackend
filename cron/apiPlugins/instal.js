...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Instal' }, {});
        if (result) {
        ...
        console.log("Instal Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Instal");
