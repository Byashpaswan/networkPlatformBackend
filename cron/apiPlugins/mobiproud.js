...
exports.callMobiproudApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobiproud/Admuxer' }, {});
        if (result) {
        ...
        console.log("Mobiproud Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobiproud");
