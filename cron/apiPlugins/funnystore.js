...
exports.callFunnyStoreApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'FunnyStore' }, {});
        if (result) {
        ...
        console.log("FunnyStore Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs FunnyStore");
