...
const debug = require("debug")("darwin:Plugin:Zettamobi");
...
exports.callZettamobiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Zettamobi' }, {});
        if (result) {
        ...
        console.log("Zettamobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Zettamobi");
