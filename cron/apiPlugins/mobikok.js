...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobikok' }, {});
        if (result) {
        ...
        console.log("Mobikok Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobikok");
