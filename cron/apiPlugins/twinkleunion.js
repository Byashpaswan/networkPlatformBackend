...
exports.callTwinkleunionApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Twinkleunion' }, {});
        if (result) {
        ...
        console.log("Twinkleunion Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Twinkleunion");
