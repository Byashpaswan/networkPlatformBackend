...
exports.callAppSamuraiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'AppSamurai' }, {});
        if (result) {
        ...
        console.log("AppSamurai Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs AppSamurai");
