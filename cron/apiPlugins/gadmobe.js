...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Gadmobe' }, {});
        if (result) {
        ...
        console.log("Gadmobe Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Gadmobe");
