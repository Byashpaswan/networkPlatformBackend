...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Kpmbro' }, {});
        if (result) {
        ...
        console.log("Kpmbro Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Kpmbro");
