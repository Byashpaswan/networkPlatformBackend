...
exports.callGamespipeApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Gamespipe' }, {});
        if (result) {
        ...
        console.log("Gamespipe Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Gamespipe");
