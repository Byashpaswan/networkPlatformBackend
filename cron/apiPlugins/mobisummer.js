...
exports.callMobisummerApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobisummer' }, {});
        if (result) {
        ...
        console.log("Mobisummer Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobisummer");
