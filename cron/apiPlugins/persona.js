...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Persona' }, {});
        if (result) {
        ...
        console.log("Persona Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Persona");
