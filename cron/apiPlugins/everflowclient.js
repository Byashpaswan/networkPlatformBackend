...
exports.callEverflowClientApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'EverflowClient' }, {});
        if (result) {
        ...
        console.log("EverflowClient Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs EverflowClient");
