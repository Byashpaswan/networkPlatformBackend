...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Tenmmads' }, {});
        if (result) {
        ...
        console.log("Tenmmads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Tenmmads");
