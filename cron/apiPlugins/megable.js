...
exports.callMobxmediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Megable' }, {});
        if (result) {
        ...
        console.log("Megable Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Megable");
