...
exports.callHugoffersApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'HugOffers' }, {});
        if (result) {
        ...
        console.log("HugOffers Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs HugOffers");
