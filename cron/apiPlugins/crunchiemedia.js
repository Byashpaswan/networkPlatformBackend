...
exports.callCrunchiemediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Crunchiemedia' }, {});
        if (result) {
        ...
        console.log("Crunchiemedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Crunchiemedia");
