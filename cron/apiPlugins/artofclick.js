...
exports.callArtofclickApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Artofclick' }, {});
        if (result) {
        ...
        console.log("Artofclick Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Artofclick");
