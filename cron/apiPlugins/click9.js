...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Clicks9' }, {});
        if (result) {
        ...
        console.log("Clicks9 Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Clicks9");
