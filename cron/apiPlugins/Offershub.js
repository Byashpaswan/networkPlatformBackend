...
exports.callOffershubApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Offershub' }, {});
        if (result) {
        ...
        console.log("Offershub Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Offershub");
