...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Oneway' }, {});
        if (result) {
        ...
        console.log("Oneway Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Oneway");
