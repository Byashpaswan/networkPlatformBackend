...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Appleads' }, {});
        if (result) {
        ...
        console.log("Appleads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Appleads");
