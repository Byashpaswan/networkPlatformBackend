...
exports.callMobivisitsApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobivisits' }, {});
        if (result) {
        ...
        console.log("Mobivisits Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobivisits");
