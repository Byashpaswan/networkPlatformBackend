...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Swaarm' }, {});
        if (result) {
        ...
        console.log("Swaarm Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Swaarm");
