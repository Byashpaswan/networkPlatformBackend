...
exports.callTrooperadsApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Trooperads' }, {});
        if (result) {
        ...
        console.log("Trooperads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Trooperads");
