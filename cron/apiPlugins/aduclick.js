...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Aduclick' }, {});
        if (result) {
        ...
        console.log("Aduclick Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Aduclick");
