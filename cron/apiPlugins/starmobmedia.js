...
exports.callStarmobMediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'StarmobMedia' }, {});
        if (result) {
        ...
        console.log("StarmobMedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs StarmobMedia");
