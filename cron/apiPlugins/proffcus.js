...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Proffcus' }, {});
        if (result) {
        ...
        console.log("Proffcus Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Proffcus");
