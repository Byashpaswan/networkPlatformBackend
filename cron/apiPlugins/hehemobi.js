...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Hehemobi' }, {});
        if (result) {
        ...
        console.log("Hehemobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Hehemobi");
