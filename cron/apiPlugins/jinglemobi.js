...
const debug = require("debug")("darwin:Plugin:Jinglemobi");
...
exports.callJinglemobiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Jinglemobi' }, {});
        if (result) {
        ...
        console.log("Jinglemobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Jinglemobi");
