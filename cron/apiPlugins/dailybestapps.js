...
exports.callDailybestappsApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Dailybestapps' }, {});
        if (result) {
        ...
        console.log("Dailybestapps Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Dailybestapps");
