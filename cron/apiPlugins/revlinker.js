...
exports.callRevlinkerApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Revlinker' }, {});
        if (result) {
        ...
        console.log("Revlinker Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Revlinker");
