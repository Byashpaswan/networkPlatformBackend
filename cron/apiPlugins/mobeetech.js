...
exports.callmobeetechApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'mobeetech' }, {});
        if (result) {
        ...
        console.log("mobeetech Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs mobeetech");
