...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Tabatoo' }, {});
        if (result) {
        ...
        console.log("Tabatoo Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Tabatoo");
