...
exports.callQverseadsApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Qverseads' }, {});
        if (result) {
        ...
        console.log("Qverseads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Qverseads");
