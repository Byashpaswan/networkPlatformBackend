...
exports.callTotoroadxApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Totoroadx' }, {});
        if (result) {
        ...
        console.log("Totoroadx Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Totoroadx");
