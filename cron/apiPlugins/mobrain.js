...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobrain' }, {});
        if (result) {
        ...
        console.log("Mobrain Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobrain");
