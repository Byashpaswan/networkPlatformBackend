...
exports.callBucksenseApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Bucksense' }, {});
        if (result) {
        ...
        console.log("Bucksense Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Bucksense");
