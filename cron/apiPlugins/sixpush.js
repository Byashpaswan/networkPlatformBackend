...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Sixpush' }, {});
        if (result) {
        ...
        console.log("Sixpush Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Sixpush");
