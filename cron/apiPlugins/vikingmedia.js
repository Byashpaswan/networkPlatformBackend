...
exports.callVikingmediaApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Vikingmedia' }, {});
        if (result) {
        ...
        console.log("Vikingmedia Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Vikingmedia");
