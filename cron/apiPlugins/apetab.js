...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Apetab' }, {});
        if (result) {
        ...
        console.log("Apetab Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Apetab");
