...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobusi' }, {});
        if (result) {
        ...
        console.log("Mobusi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobusi");
