...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Clixsad' }, {});
        if (result) {
        ...
        console.log("Clixsad Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Clixsad");
