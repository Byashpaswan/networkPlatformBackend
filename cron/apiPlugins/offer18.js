...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Offer18' }, {});
        if (result) {
        ...
        console.log("Offer18 Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Offer18");
