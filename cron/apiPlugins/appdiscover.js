...
exports.callAppDiscoverApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'AppDiscover' }, {});
        if (result) {
        ...
        console.log("AppDiscover Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs AppDiscover");
