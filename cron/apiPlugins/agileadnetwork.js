...
exports.callAgileadnetworkApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Agileadnetwork' }, {});
        if (result) {
        ...
        console.log("Agileadnetwork Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Agileadnetwork");
