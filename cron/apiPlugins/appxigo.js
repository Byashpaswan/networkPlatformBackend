...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Appxigo' }, {});
        if (result) {
        ...
        console.log("Appxigo Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Appxigo");
