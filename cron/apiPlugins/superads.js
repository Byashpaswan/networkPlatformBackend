...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Superads' }, {});
        if (result) {
        ...
        console.log("Superads Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Superads");
