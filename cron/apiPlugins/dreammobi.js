...
exports.callDreamMobiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'DreamMobi' }, {});
        if (result) {
        ...
        console.log("DreamMobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs DreamMobi");
