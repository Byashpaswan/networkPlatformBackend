...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'WhatsCpi' }, {});
        if (result) {
        ...
        console.log("WhatsCpi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs WhatsCpi");
