...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Leverage/Echo226' }, {});
        if (result) {
        ...
        console.log("Echo226 Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Echo226");
