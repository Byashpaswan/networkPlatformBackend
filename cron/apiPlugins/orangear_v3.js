...
exports.callOrangear_v3Api = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Orangear_V3' }, {});
        if (result) {
        ...
        console.log("Orangear_v3 Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Orangear_v3");
