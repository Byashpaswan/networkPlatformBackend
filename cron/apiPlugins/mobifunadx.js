...
exports.callMobifunadxApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Mobifunadx' }, {});
        if (result) {
        ...
        console.log("Mobifunadx Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Mobifunadx");
