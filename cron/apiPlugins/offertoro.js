...
exports.callOffertoroApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Offertoro' }, {});
        if (result) {
        ...
        console.log("Offertoro Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Offertoro");
