...
exports.callIndexmobiApi = async () => {
    try {
...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Indexmobi' }, {});
        if (result) {
        ...
        console.log("Indexmobi Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Indexmobi");
