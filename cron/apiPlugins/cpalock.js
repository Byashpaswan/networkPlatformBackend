...
async function assignWork() {
    let jobs = 0;
    try {
        let result = await PlatformTypeModel.getPlatformTypesOne({ name: 'Cpalock/ Mobpals' }, {});
        if (result) {
        ...
        console.log("Cpalock Job Inserted ", jobs);

    }
    catch (err) {
        console.log("error occured during assigning jobs Cpalock");
