...
const debug = require("debug")("darwin:Plugin:Adsplay");
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.api_key && credentials.affiliate_id) {
        ...
        let apiBaseurl = "http://affiliates.adsplay.in/api/json/?type=findAll&api_key=" + api_key + "&api_aid=" + affiliate_id;
        // debug(apiBaseurl)
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "affiliates.adsplay.in";
...
function getTrackingLink(field, data) {
    ...
    if (data.tracking_url)
        tracking_link = data.tracking_url.split('&subid1')[0];
...
function getIsTargeting(field, data) {
    ...
    if ((data.countries && data.countries.length) || (data.os && data.os.length)) {
...
function getStatusLabel(field, data) {
    ...
    if (data.tracking_url && data.status) {
        status_label = "active";
    }
    else {
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = Adsplay[action](field, offer);
