...
const debug = require("debug")("darwin:Plugin:tenmmads");
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.appKey && credentials.affId) {
        let appKey = credentials['appKey'];
        let affId = credentials['affId'];
        let apiBaseurl = "http://offer.tenmmads.com/v1/offer/get?appKey=" + appKey + "&affId=" + affId;
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "offer.tenmmads.com";
...
function getIsTargeting(field, data) {
    ...
    if ((data.countries && data.countries.length) || (data.mobile_platform)) {
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = tenmmads[action](field, offer);
