...
const debug = require("debug")("darwin:Plugin:adbink");
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.api_key) {
        ...
        let apiBaseurl = 'http://adbink-api.appone.link/exchange?auth=' + api_key
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "adbink-api.appone.link";
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = adbink[action](field, offer);
