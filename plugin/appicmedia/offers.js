...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials['api-key']) {
        ...
        let apiBaseurl = `https://api.appicmedia.com/api.php?affid=${affid}&api-key=${api_key}&status=active`;
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "api.appicmedia.com";
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = appicmedia[action](field, offer);
