...
const debug = require("debug")("darwin:Plugin:Vortexmedia");
...
exports.countApiPages = (response) => {
    try {
        let nextpage = false;
        // if (response.total && response.total == limit) {
        //     nextpage = true;
        // }
        return nextpage;
    }
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.api_key) {
        ...
        let apiBaseurl = "http://api.vortexmedia.mobi/v1/offer?token=" + api_key + "&limit=" + apilimit;
        // debug(apiBaseurl)
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "api.vortexmedia.mobi";
...
exports.checkValid = (result) => {
    if (result.msg && result.msg == 'success' && result.data) {
...
function getIsTargeting(field, data) {
    ...
    if (data.country || data.platform || data.os) {
...
function getStatusLabel(field, data) {
    ...
    if (data.offer_url && data.offer_url !== '') {
        status_label = "active";
    }
    else {
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = Vortexmedia[action](field, offer);
