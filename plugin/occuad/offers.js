...
const debug = require("debug")("darwin:Plugin:Occuad");
...
// http://api.hehemobi.com/v2/offer/pull?token={your_api_token}
// http://api.hopemobi.net/v2/offer/pull?token={your_api_token}
// http://api.honeycombmobi.com/v2/offer/pull?token={your_api_token}
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.api_key && credentials.network_id) {
        ...
        let apiBaseurl = "http://" + network_id + "/v2/offer/pull?token=" + api_key + "&size=" + apilimit + "&page=";
        // debug(apiBaseurl)
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = occuad[action](field, offer);
