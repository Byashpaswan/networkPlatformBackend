...
const debug = require("debug")("darwin:Plugin:skyworker");
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.token) {
        ...
        let apiBaseurl = 'http://adapi.iskyworker.com/v2/offer/pull?token=' + token + '';
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "adapi.iskyworker.com";
...
function getOfferCapping(field, data) {
    ...
    if (data.r_cap_daily) {
        cap.daily_revenue = data['r_cap_daily']
    }
    return cap;
}
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = skyworker[action](field, offer);
