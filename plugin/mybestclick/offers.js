...
const debug = require("debug")("darwin:Plugin:myBestClick");
...
exports.apiCall = async (credentials, page, apilimit) => {
    if (credentials.affiliate_id && credentials.api_key) {
        ...
        let apiBaseurl = "https://www.mybestclick.mobi/api.php?method=getOffers&aid=" + affiliate_id + "&images=true&key=" + api_key + "&num=" + apilimit;
        // debug(apiBaseurl)
            ...
            do {
                ...
                if (result) {
                    ...
                    if (valid === true) {
                        ...
                        content['domain'] = "www.mybestclick.mobi";
...
exports.checkValid = (result) => {
    if (result.error_code == 0 && result.offers) {
        return true;
    }
    else {
        return false;
...
function getApprovalRequired(field, data) {
    ...
    if (data.require_approval)
        approval_required = data.require_approval;
...
function getOfferCapping(field, data) {
    ...
    if (data.daily_conversions) {
        ...
        cap.daily_revenue = data.daily_revenue;
        ...
        cap.monthly_revenue = data.monthly_revenue;
    }
    return cap;
}
...
function getIsTargeting(field, data) {
    ...
    if ((data.geo && data.geo.length) || (data.devices && data.devices.length)) {
...
function formateOffers(offer) {
    ...
    array.map(function (obj) {
        try {
            ...
            let data = myBestClick[action](field, offer);
