...
const debug = require("debug")("darwin:Plugin:seanear");
...
exports.apiCall = async (credentials, page, apilimit) => {
  if (credentials.publisher_id && credentials.access_token) {
    ...
    let apiBaseurl =
      "http://api.seanear.com/get_campaigns?publisher_id=" + publisher_id + "&access_token=" + access_token
      ...
      do {
        ...
        if (result) {
          ...
          if (valid === true) {
            ...
            content['domain'] = "api.seanear.com";
...
function formateOffers(offer) {
  ...
  array.map(function (obj) {
    try {
      ...
      let data = seanear[action](field, offer);
